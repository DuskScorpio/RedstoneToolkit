...
- [ViaFabricPlus](https://modrinth.com/mod/viafabricplus) [[4]](#ref-4) – Allows connecting to almost any Minecraft server version and includes various client-side fixes for older protocol versions.
